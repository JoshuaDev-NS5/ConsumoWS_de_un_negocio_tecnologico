<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmClientes.aspx.cs" Inherits="ConsumoWS.frmClientes" %>
...
<body>
    <div class="container">
        <h1 class="text-center">Mantenimiento de Cliente</h1>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>   
                    ...
                    <div class="table-responsive" id="scrollBottom" >
                        ...
                        <asp:GridView ID="grvCliente" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover  table-bordered" OnRowCommand="grvCliente_RowCommand" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="apepcli" HeaderText="A.Paterno" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="apemcli" HeaderText="A.Materno" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="doccli" HeaderText="Documento" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="dircli" HeaderText="Direccion" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="feccli" HeaderText="Fecha de Nacimiento" HeaderStyle-CssClass="table-dark" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false" />
                                <asp:BoundField DataField="naccli" HeaderText="Nacionalidad" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="telcli" HeaderText="Teléfono Fijo" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="celcli" HeaderText="Celular" HeaderStyle-CssClass="table-dark" />
                                <asp:BoundField DataField="corcli" HeaderText="Correo" HeaderStyle-CssClass="table-dark" />
